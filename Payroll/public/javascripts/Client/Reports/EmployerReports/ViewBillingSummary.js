...
onloadHtml += '<th style="text-align:left; padding-left:5px;">Invoice Date</th>';
onloadHtml += '<th style="text-align:left; padding-left:5px;">From Date</th>';
onloadHtml += '<th style="text-align:right;">To Date</th>';
...
function FillGrid() {    
    ...
    CallService('Client/Reports/EmployerReports/BillingSummary.svc', 'BillingSummary', params, OnBillingSummaryGetAllSuccess, true);
}

function OnBillingSummaryGetAllSuccess(arrSummary) {
    ...
    if (arrSummary != undefined) {
        ...
        for (var i = 0; i < arrSummary.length; i++) {
            ...
            html += '<td style="text-align:left; padding-left:5px;">' + _.escape(FormatDateUTC(arrSummary[i].InvoiceDate)) + '</td>';
            html += '<td style="text-align:left; padding-left:5px;">' + _.escape(FormatDateUTC(arrSummary[i].FromDate)) + '</td>';
            html += '<td style="text-align:right; padding-left:5px;">' + _.escape(FormatDateUTC(arrSummary[i].ToDate)) + '</td>';
            html += '<td style="text-align:right; padding-left:5px;">' + _.escape(arrSummary[i].PlanName) + '</td>';
