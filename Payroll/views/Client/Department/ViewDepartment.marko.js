function create(__helpers) {
  ...
  return function render(data, out) {
    ...
    out.w(" <script src=\"" +
      ...
      "/javascripts/Client/Department/ViewDepartment.js\"></script> ");
