function create(__helpers) {
  ...
  return function render(data, out) {
    ...
    out.w(" <section class=\"main-container\"> <div class=\"container-fluid\"> <div class=\"page-header filled full-block light\"> <div class=\"row\"> <div class=\"col-md-6\"> <h2>" +
      ...
      escapeXml(data.PageHeading) +
      "</li> </ul> </div> </div> </div> <div class=\"row\"> <div class=\"col-md-12\"> <div class=\"widget-wrap\"> <div class=\"widget-container\"> <div class=\"widget-content\"> <input type=\"hidden\" id=\"hdnFeatureId\"" +
      attr("value", data.FeatureId) +
      "> <table class=\"tableEntry\"> <tr> <td> Feature Code:<span class=\"required\">*</span> </td> <td> <span id=\"spanFeatureCode\"></span> </td> </tr> <tr> <td> Feature Name:<span class=\"required\">*</span> </td> <td> <span id=\"spanFeatureName\"></span> </td> </tr> <tr> <td> Display Order:<span class=\"required\">*</span> </td> <td> <span id=\"spanDisplayOrder\"></span> </td> </tr> <tr> <td></td> <td> <button id=\"btnEdit\" class=\"btn btn-primary\" onclick=\"Edit()\">Edit</button>&nbsp;&nbsp; <button id=\"btnClose\" class=\"btn btn-default\" onclick=\"Close()\">Close</button> </td> </tr> </table> </div> </div> </div> </div> </div> </div> ");
    ...
    out.w(" <script src=\"" +
      ...
      "/javascripts/Admin/Feature/ViewFeature.js\"></script> ");
