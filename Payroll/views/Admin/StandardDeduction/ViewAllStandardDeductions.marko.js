function create(__helpers) {
  ...
  return function render(data, out) {
    ...
    out.w(" <section class=\"main-container\"> <div class=\"container-fluid\"> <div class=\"page-header filled full-block light\"> <div class=\"row\"> <div class=\"col-md-6\"> <h2>" +
      ...
      "</h2> <ul class=\"list-page-breadcrumb\"> <li class=\"active-page\"> Standard Deduction (California)</li> </ul> </div> </div> </div> <div class=\"row\"> <div class=\"col-md-12\"> <div class=\"widget-wrap\"> <div class=\"widget-container\"> <div class=\"widget-content\"> ");
    ...
    out.w(" <script src=\"" +
      ...
      escapeXmlAttr(data.CDNUrl) +
      "/javascripts/Admin/StandardDeduction/ViewAllStandardDeductions.js\"></script> <script src=\"" +
      escapeXmlAttr(data.CDNUrl) +
