function create(__helpers) {
  ...
  return function render(data, out) {
    ...
    out.w(" <section class=\"main-container\"> <div class=\"container-fluid\"> <div class=\"page-header filled full-block light\"> <div class=\"row\"> <div class=\"col-md-6\"> <h2>" +
      ...
      "</h2> <ul class=\"list-page-breadcrumb\"> <li class=\"active-page\"> Directory</li> </ul> </div> </div> </div> <div class=\"row\"> <div class=\"col-md-12\"> <div class=\"widget-wrap\"> <div class=\"widget-container\"> <div class=\"widget-content\"> <table style=\"width:100%\"> <tr> <td style=\"width:100px\"> Department: </td> <td style=\"width: 250px; padding: 5px 0px 5px 0px\"> <select id=\"cmbDepartmentName\" class=\"form-control\"> </select> </td> <td style=\"width:100px\"> Location: </td> <td style=\"width: 250px; padding: 5px 0px 5px 0px\"> <select id=\"cmbLocationName\" class=\"form-control\"> </select> </td> </tr> </table> </div> </div> </div> </div> </div> <div class=\"row\"> <div class=\"col-md-12\"> <div class=\"widget-wrap\"> <div class=\"widget-container\"> <div class=\"widget-content\"> <table style=\"width:100%\"> <tr> <td colspan=\"2\"> <strong><span id=\"spanClientName\"></span></strong> </td> </tr> <tr> <td> Directory </td> <td>");
    ...
    out.w(" <script src=\"https://cdnjs.cloudflare.com/ajax/libs/FileSaver.js/1.3.3/FileSaver.min.js\"></script> <script src=\"" +
      ...
      "/javascripts/Client/Reports/EmployeeReports/ViewDirectory.js\"></script> ");
