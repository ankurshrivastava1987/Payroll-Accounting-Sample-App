function create(__helpers) {
  ...
  return function render(data, out) {
    ...
    out.w(" <script src=\"" +
      ...
      escapeXmlAttr(data.CDNUrl) +
      "/javascripts/Admin/AllowanceStatusSetup2/AllowanceStatusSetup2.js\"></script> ");
