exports.ViewAllClients = function (req, res) {
    var template = Marko.load(require.resolve('../../../views/Admin/Client/ViewAllClients.marko'));
...
exports.ViewClient = function (req, res) {
    var template = Marko.load(require.resolve('../../../views/Admin/Client/ViewClient.marko'));
    res.setHeader('Content-Type', 'text/html; charset=utf-8');
    template.render({
...
exports.EditClient = function (req, res) {
    var template = Marko.load(require.resolve('../../../views/Admin/Client/Client.marko'));
    res.setHeader('Content-Type', 'text/html; charset=utf-8');
    template.render({
