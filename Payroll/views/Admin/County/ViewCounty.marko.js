function create(__helpers) {
  ...
  return function render(data, out) {
    ...
    out.w(" <script src=\"" +
      ...
      "/javascripts/Admin/County/ViewCounty.js\"></script> ");
