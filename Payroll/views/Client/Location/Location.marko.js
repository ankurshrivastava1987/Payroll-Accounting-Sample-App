function create(__helpers) {
  ...
  return function render(data, out) {
    ...
    out.w(" </head> <body class=\"leftbar-view\"> <input type=\"hidden\" id=\"hdnLocationId\"" +
      attr("value", data.LocationId) +
      "> ");
    ...
    out.w(" <script src=\"" +
      ...
      "/javascripts/Client/Location/Location.js\"></script> ");
