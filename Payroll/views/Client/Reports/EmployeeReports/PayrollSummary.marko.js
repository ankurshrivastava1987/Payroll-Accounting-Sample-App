function create(__helpers) {
  ...
  return function render(data, out) {
    ...
    out.w(" <script src=\"" +
      ...
      escapeXmlAttr(data.CDNUrl) +
      "/javascripts/Client/Reports/EmployeeReports/PayrollSummary.js\"></script> ");
