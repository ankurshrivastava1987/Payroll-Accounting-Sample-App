function create(__helpers) {
  ...
  return function render(data, out) {
    ...
    out.w(" <section class=\"main-container\"> <div class=\"container-fluid\"> <div class=\"page-header filled full-block light\"> <div class=\"row\"> <div class=\"col-md-6\"> <h2>" +
      ...
      "</h2> <ul class=\"list-page-breadcrumb\"> <li class=\"active-page\">Payroll Details</li> </ul> </div> </div> </div> <div class=\"row\"> <div class=\"col-md-12\"> <div class=\"widget-wrap\"> <div class=\"widget-container\"> ");

    ___ReportToolbar.render({
        CDNUrl: data.CDNUrl
      }, out);

    out.w(" <div id=\"divLastPayCheck\" class=\"widget-content\"> <div style=\"width:100%; border: 1px solid #90949b;\"> <table style=\"width:100%\"> <tr> <td style=\"width: 100px; text-align:left; padding-left:5px;\"> From Date: </td> <td style=\"width: 250px; padding: 5px 0px 5px 0px;\"> <input id=\"txtFromDate\" name=\"txtFromDate\" type=\"text\" class=\"form-control input-date-picker\" readonly> </td> <td style=\"width:100px;padding-left:5px;\"> To Date: </td> <td style=\"width: 250px; padding: 5px 0px 5px 0px\"> <input id=\"txtToDate\" name=\"txtToDate\" type=\"text\" class=\"form-control input-date-picker\" readonly> </td> <td style=\"width: 250px; padding: 5px 5px 5px 5px\"> <select width=\"200px\" id=\"cmbLocationName\" class=\"form-control\"></select> </td> <td style=\"width: 250px; padding: 5px 5px 5px 5px\"> <select width=\"200px\" id=\"cmbEmployeeName\" class=\"form-control\"></select> </td> <td style=\"padding: 5px 5px 5px 5px\"> <button id=\"btnGo\" type=\"button\" class=\"btn btn-primary\" onclick=\"FillGrid()\"> <i class=\"fa fa-check\" aria-hidden=\"true\"></i> Go</button> </td> </tr> </table> </div> <br> <div id=\"divPayrollDetails\" style=\"width:100%;\"> </div> </div> </div> </div> </div> </div> </div> ");
    ...
    out.w(" <script src=\"" +
      ...
      escapeXmlAttr(data.CDNUrl) +
      "/javascripts/Client/Reports/EmployeeReports/PayrollDetails.js\"></script> ");
