function create(__helpers) {
  ...
  return function render(data, out) {
    ...
    out.w(" <section class=\"main-container\"> <div class=\"container-fluid\"> <div class=\"page-header filled full-block light\"> <div class=\"row\"> <div class=\"col-md-6\"> <h2>" +
      ...
      "</h2> <ul class=\"list-page-breadcrumb\"> <li> <a href=\"/Admin/ClientTaxSetup/ViewAllClientTaxSetups\"> Tax Setup <i class=\"zmdi zmdi-chevron-right\"></i> </a> </li> <li class=\"active-page\"> " +
      escapeXml(data.PageHeading) +
      "</li> </ul> </div> </div> </div> <div class=\"row\"> <div class=\"col-md-12\"> <div class=\"widget-wrap\"> <div class=\"widget-container\"> <div class=\"widget-content\"> <form method=\"post\" class=\"j-forms\" id=\"frmEntry\"> <input type=\"hidden\" id=\"hdnClientTaxSetupId\"" +
      attr("value", data.ClientTaxSetupId) +
      "> <table class=\"tableEntry\"> <tr> <td> Effective Date:<span class=\"required\">*</span> </td> <td style=\"width:310px;\"> <div class=\"unit\"> <div class=\"input\"> <input id=\"txtEffectiveDate\" name=\"txtEffectiveDate\" type=\"text\" class=\"form-control cal-date-picker\" readonly> </div> </div> </td> </tr> <tr> <td> State:<span class=\"required\">*</span> </td> <td> <div class=\"unit\"> <div class=\"input\"> <select id=\"cmbStateName\" name=\"cmbStateName\" class=\"form-control\"></select> </div> </div> </td> </tr> <tr> <td> SUI Tax(Employer) %: </td> <td> <div class=\"unit\"> <div class=\"input\"> <input id=\"txtSUITaxEmployer\" class=\"form-control decimal6\" value=\"0.000000\"> </div> </div> </td> </tr> <tr> <td> Min. Limit(in one Quarter): </td> <td> <div class=\"unit\"> <div class=\"input\"> <input id=\"txtMinLimit\" class=\"form-control decimal\" value=\"0.00\"> </div> </div> </td> </tr> <tr> <td> Max. Limit: </td> <td> <div class=\"unit\"> <div class=\"input\"> <input id=\"txtMaxLimit\" class=\"form-control decimal\" value=\"0.00\"> </div> </div> </td> </tr> </table> <table> <tr> <td></td> <td style=\"padding-top:20px\"> <button id=\"btnSave\" type=\"button\" class=\"btn btn-primary\" onclick=\"Save()\"> <i class=\"fa fa-floppy-o\" aria-hidden=\"true\"></i> Save </button>&nbsp; <button id=\"btnClose\" type=\"button\" class=\"btn btn-primary\" onclick=\"Close()\"> <i class=\"fa fa-times\" aria-hidden=\"true\"></i> Close </button> </td> </tr> </table> </form> </div> </div> </div> </div> </div> </div> ");
    ...
    out.w(" <script src=\"" +
      ...
      escapeXmlAttr(data.CDNUrl) +
      "/javascripts/Client/ClientTaxSetup/ClientTaxSetup.js\"></script> ");
