...
$(".spark-pie-chart").each(function(){
    ...
    bb_demos.custom_html = function () {
      var MyDialog =  bootbox.dialog({
            ...
            message: '<form id="formUpload" action="/Payroll.Services/Client/ClientService.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
    ...
    // Federal Tax Setup Html Contents
    bb_demos.FederalTaxSetup_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import Federal Tax Setup",
            message: '<form id="formUpload" action="/Payroll.Services/Admin/FederalTaxSetupService.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    // State Tax Setup Html Contents
    bb_demos.StateTaxSetup_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import State Tax",
            message: '<form id="formUpload" action="/Payroll.Services/Admin/StateTaxSetupService.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    // State Tax Setup Html Contents
    bb_demos.StateTaxSetup1_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import State Tax Setup1",
            message: '<form id="formUpload" action="/Payroll.Services/Admin/StateTaxSetup1Service.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    // State Tax Setup Html Contents
    bb_demos.StateTaxSetup2_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import State Tax Setup2",
            message: '<form id="formUpload" action="/Payroll.Services/Admin/StateTaxSetup2Service.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    // State Tax Setup Html Contents
    bb_demos.StateTaxSetup3_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import State Tax Setup3",
            message: '<form id="formUpload" action="/Payroll.Services/Admin/StateTaxSetup3Service.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    // State Tax Setup Html Contents
    bb_demos.StateTaxSetup4_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import State Tax Setup4",
            message: '<form id="formUpload" action="/Payroll.Services/Admin/StateTaxSetup4Service.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    // State Tax Setup Html Contents
    bb_demos.AllowanceChartSetup_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import Allowance Chart Setup",
            message: '<form id="formUpload" action="/Payroll.Services/Admin/AllowanceChartSetupService.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    // State Tax Setup Html Contents
    bb_demos.AllowanceStatusSetup_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import Allowance Status Setup",
            message: '<form id="formUpload" action="/Payroll.Services/Admin/AllowanceStatusSetupService.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    // State Tax Setup Html Contents
    bb_demos.AllowanceStatusSetup1_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import Allowance Status Setup1",
            message: '<form id="formUpload" action="/Payroll.Services/Admin/AllowanceStatusSetup1Service.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    // State Tax Setup Html Contents
    bb_demos.AllowanceStatusSetup2_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import Allowance Status Setup2",
            message: '<form id="formUpload" action="/Payroll.Services/Admin/AllowanceStatusSetup2Service.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    bb_demos.CountyTaxSetup_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import County Tax Setup",
            message: '<form id="formUpload" action="/Payroll.Services/Admin/CountyTaxSetupService.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    bb_demos.DeductionConstantSetup_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import Deduction Constant Setup",
            message: '<form id="formUpload" action="/Payroll.Services/Admin/DeductionConstantSetupService.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    bb_demos.TaxSlabSetup_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import Tax Slab Setup",
            message: '<form id="formUpload" action="/Payroll.Services/Admin/TaxSlabSetupService.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    bb_demos.TaxBracketSetup_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import Tax Bracket Setup",
            message: '<form id="formUpload" action="/Payroll.Services/Admin/TaxBracketSetupService.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    bb_demos.LowIncomeExemption_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import Low Income Exemption",
            message: '<form id="formUpload" action="/Payroll.Services/Admin/LowIncomeExemptionService.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    bb_demos.ExemptionAllowance_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import Exemption Allowance",
            message: '<form id="formUpload" action="/Payroll.Services/Admin/ExemptionAllowanceService.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    bb_demos.EstimatedDeduction_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import Estimated Deduction",
            message: '<form id="formUpload" action="/Payroll.Services/Admin/EstimatedDeductionService.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    bb_demos.StandardDeduction2_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import Standard Deduction2",
            message: '<form id="formUpload" action="/Payroll.Services/Admin/StandardDeduction2Service.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    bb_demos.StandardDeduction1_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import Standard Deduction1",
            message: '<form id="formUpload" action="/Payroll.Services/Admin/StandardDeductionService.svc/Upload" method="post" enctype="multipart/form-data"><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    // Import employees Html Contents | Added by ankur 
    bb_demos.EmployeeUpload_html = function () {
        var MyDialog = bootbox.dialog({
            title: "Import Employees",
            message: '<form id="formUpload" action="/Payroll.Services/Client/EmployeeService.svc/ImportEmployee" method="post" enctype="multipart/form-data"><input type="hidden" id="hdnClientID" name="hdnClientID" value="' + $.localStorage.get('ClientId') + '"/><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    bb_demos.EmployeeDocument = function () {
        var MyDialog = bootbox.dialog({
            title: "Upload Document",
            message: '<form id="formUpload" action="/Payroll.Services/Client/EmployeeService.svc/Upload" method="post" enctype="multipart/form-data"><input type="hidden" id="hdnEmployeeId1" name="hdnCurrentPath2" value="' + $('#hdnCurrentPath').val() + '"/><div class="row"><div class="col-md-6"><input type="file" name="fileUpload"/></div><div class="col-md-6 text-right"><button id="btnUpload" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
    ...
    bb_demos.EmployeeCreateFolder = function () {
        var MyDialog = bootbox.dialog({
            title: "Create Folder",
            message: '<form id="formUpload" action="/Payroll.Services/Client/EmployeeService.svc/CreateFolder" method="post"><input type="hidden" id="hdnCurrentPath1" name="hdnCurrentPath1" value="' + $('#hdnCurrentPath').val() + '"/><div class="row"><div class="col-md-6"><input name="txtFolderName" style="width:250px"/></div><div class="col-md-6 text-right"><button id="btnSubmit" type="submit" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button></div></div></form>'
        });
        $('#formUpload').submit(function () {
            $(this).ajaxSubmit({
                beforeSend: function (xhr) {
