function create(__helpers) {
  ...
  return function render(data, out) {
    ...
    out.w(" <section class=\"main-container\"> <div class=\"container-fluid\"> <div class=\"page-header filled full-block light\"> <div class=\"row\"> <div class=\"col-md-6\"> <h2>" +
      ...
      "</h2> <ul class=\"list-page-breadcrumb\"> <li class=\"active-page\"> Pay Stubs</li> </ul> </div> </div> </div> <div class=\"row\"> <div class=\"col-md-12\"> <div class=\"widget-wrap\"> <div class=\"widget-container\"> <div class=\"widget-content\"> ");

    ___GridToolbar.render({
        CDNUrl: data.CDNUrl
      }, out);

    out.w(" <input type=\"hidden\" id=\"txtSortField\" value=\"PayStubId\"> <input type=\"hidden\" id=\"txtSortDirection\" value=\"DESC\"> <input type=\"hidden\" id=\"txtCurrentPageIndex\" value=\"1\"> <input type=\"hidden\" id=\"txtPageSize\"" +
      attr("value", data.GridPageSize) +
      "> <input type=\"hidden\" id=\"txtTotalRecords\" value=\"0\"> <input type=\"hidden\" id=\"txtCurrentRecordCount\" value=\"0\"> <table class=\"table foo-data-table-filterable\"> <thead> <tr> <th style=\"width: 25px\" data-sort-ignore=\"true\"> <input id=\"chkAll\" type=\"checkbox\" name=\"0\" onclick=\"CheckAll()\"> </th> <th> <a onclick=\"SortTable(&#39;PayStubName&#39;)\"> <u>Pay Stub Name</u> </a> </th> <th> <a onclick=\"SortTable(&#39;PayStubType&#39;)\"> <u>Type</u> </a> </th> <th> <a onclick=\"SortTable(&#39;Taxable&#39;)\"> <u>Taxable</u> </a> </th> <th style=\"width: 100px;text-align:center\" data-sort-ignore=\"true\"> <a>Action</a> </th> </tr> </thead> <tbody id=\"bodyPayStubs\"> </tbody> </table> <div id=\"divPager\"> </div> </div> </div> </div> </div> </div> </div> ");
    ...
    out.w(" <script src=\"" +
      ...
      escapeXmlAttr(data.CDNUrl) +
      "/javascripts/Client/PayStub/ViewAllPayStubs.js\"></script> <script src=\"" +
      escapeXmlAttr(data.CDNUrl) +
