function create(__helpers) {
  ...
  return function render(data, out) {
    ...
    out.w(" <section class=\"main-container\"> <div class=\"container-fluid\"> <div class=\"page-header filled full-block light\"> <div class=\"row\"> <div class=\"col-md-6\"> <h2>" +
      ...
      "> <ul class=\"nav nav-tabs\" role=\"tablist\"> <li role=\"presentation\" class=\"active\"> <a href=\"#Step1\" aria-controls=\"Step1\" role=\"tab\" data-toggle=\"tab\" class=\"link\"> <strong>Primary Info</strong> </a> </li> <li role=\"presentation\"> <a href=\"#Step2\" aria-controls=\"Step2\" role=\"tab\" data-toggle=\"tab\" class=\"link\"> <strong>Standard Deduction</strong> </a> </li> <li role=\"presentation\"> <a href=\"#Step3\" aria-controls=\"Step3\" role=\"tab\" data-toggle=\"tab\" class=\"link\"> <strong>Personal Allowance</strong> </a> </li> <li role=\"presentation\"> <a href=\"#Step4\" aria-controls=\"Step4\" role=\"tab\" data-toggle=\"tab\" class=\"link\"> <strong>Dependent Allowance</strong> </a> </li> </ul> <div class=\"tab-content\"> <div role=\"tabpanel\" class=\"tab-pane active\" id=\"Step1\" style=\"padding-top:20px\"> <table class=\"tableEntry\"> <tr> <td> State:<span class=\"required\">*</span> </td> <td> <span id=\"spanStateName\"></span> </td> </tr> <tr> <td> Effective Date:<span class=\"required\">*</span> </td> <td> <span id=\"spanEffectiveDate\"></span> </td> </tr> </table> </div> <div role=\"tabpanel\" class=\"tab-pane\" id=\"Step2\" style=\"padding-top:20px\"> <table id=\"tblStandardDeduction\" class=\"table foo-data-table table-bordered\"> <thead> </thead> <tbody id=\"bodyStandardDeduction\"> </tbody> </table> </div> <div role=\"tabpanel\" class=\"tab-pane\" id=\"Step3\" style=\"padding-top:20px\"> <table id=\"tblPersonalAllowance\" class=\"table foo-data-table table-bordered\"> <thead> </thead> <tbody id=\"bodyPersonalAllowance\"> </tbody> </table> </div> <div role=\"tabpanel\" class=\"tab-pane\" id=\"Step4\" style=\"padding-top:20px\"> <table id=\"tblDependentAllowance\" class=\"table foo-data-table table-bordered\"> <thead> </thead> <tbody id=\"bodyDependentAllowance\"> </tbody> </table> </div> </div> <table> <tr> <td></td> <td style=\"padding-top:20px;\"> <button id=\"btnEdit\" type=\"button\" class=\"btn btn-primary\" onclick=\"Edit()\"> <i class=\"fa fa-pencil\" aria-hidden=\"true\"></i> Edit </button>&nbsp; <button id=\"btnClose\" type=\"button\" class=\"btn btn-primary\" onclick=\"Close()\"> <i class=\"fa fa-times\" aria-hidden=\"true\"></i> Close </button> </td> </tr> </table> </div> </div> </div> </div> </div> </div> ");
    ...
    out.w(" <script src=\"" +
      ...
      escapeXmlAttr(data.CDNUrl) +
      "/javascripts/Admin/AllowanceStatusSetup/ViewAllowanceStatusSetup.js\"></script> ");
